function add(s, f) {
	...
	db.user.insert({_id:j, full_name:"Иванов Иван Иванович ", login:(log+j), pass:(log+j), role:"Кассир", user_date: {photo:"C:\Users\ASUS\Desktop\JS\MongoDB\ЛАБА № 6\1.jpg", dob:new Date()}})
}
